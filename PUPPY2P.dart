...
class PUPPY2P extends StatefulWidget {
  const PUPPY2P({super.key});

  @override
  State<PUPPY2P> createState() => _PUPPY2PState();
}

class _PUPPY2PState extends State<PUPPY2P> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Drools Focus Puppy Super Premium Dry Dog Food, 4Kg',
                style: TextStyle(
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text(
                '- A complete and balanced nutrition for your pet made with No Wheat, No Corn and No Soya', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Real Chicken, our No. 1 ingredient, is an excellent source of high quality protein, that helps to maintain a healthy body', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text(
                '- Whole grains like rice and oats help to absorb the nutrients and improve the digestive system', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Optimal level of Omega 3 and 6 fatty acids along with Biotin, Zinc and Vitamin E ensures Healthy Skin and Shiny Coat', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- A combination of natural ingredients from Drools will help your pet secure all the health benefits needed in the long run', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
