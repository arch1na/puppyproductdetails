...
class PUPPY4P extends StatefulWidget {
  const PUPPY4P({super.key});

  @override
  State<PUPPY4P> createState() => _PUPPY4PState();
}

class _PUPPY4PState extends State<PUPPY4P> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Pet Patrol Puppy Dry Food for The Healthy Start DHA (Brain Development) (1.2 Kg)',
                style: TextStyle(
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text(
                '- Tailored for puppies unique nutritional needs, supporting healthy growth', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Premium, real chicken protein source for strong muscles and development.', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text(
                '- Balanced formula with essential vitamins, minerals, and antioxidants for vitality.', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- veterinarian recommended, trusted for your puppys health and well-being.', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Store in a cool, dry place to maintain freshness and quality.', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
