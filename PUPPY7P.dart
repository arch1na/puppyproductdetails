...
class PUPPY7P extends StatefulWidget {
  const PUPPY7P({super.key});

  @override
  State<PUPPY7P> createState() => _PUPPY7PState();
}

class _PUPPY7PState extends State<PUPPY7P> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Royal Canin Medium Puppy Dry Dog Food, 15 Kg',
                style: TextStyle(
            ...
            Row(
              children: [
                ...
                Text('  ₹9,990', style: TextStyle(
                    color: Colors.black,
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Inter',
                    fontSize: 15
                ),),
                Text(' 13% Off', style: TextStyle(
            ...
            Padding(
              ...
              child: Text(
                '- Supports immune system health', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
