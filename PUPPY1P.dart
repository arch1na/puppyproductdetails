...
class PUPPY1P extends StatefulWidget {
  const PUPPY1P({super.key});

  @override
  State<PUPPY1P> createState() => _PUPPY1PState();
}

class _PUPPY1PState extends State<PUPPY1P> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Pedigree Puppy Dry Dog Food,Chicken & Milk, 1.2kg',
                style: TextStyle(
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text(
                '- Complete & balanced dog food, a perfect food for puppy', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Contains 24% crude Protein, 10% crude Fat, and 5% crude Fibre', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text(
                '- Provides strong muscles, bones & teeth and healthier & shinier coat', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- dog food that also ensures optimal digestion of nutrients and supports Natural Defences', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Provides dogs the 5 Signs of Good Health - a PEDIGREE assurance! On opening the pack, store Pedigree dog food in an air-tight container, in a cool and dry place, away from sunlight', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Puppies need 24x Protein, 9.5x Calcium & 53x Iron B12 than human babies, an ideal treat', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Developed by experts at the Waltham Centre for Pet Nutrition', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Ideal for Pugs, Beagle to Labrador, Golden Retriever & German shepherd', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
