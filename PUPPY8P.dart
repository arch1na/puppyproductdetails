...
class PUPPY8P extends StatefulWidget {
  const PUPPY8P({super.key});

  @override
  State<PUPPY8P> createState() => _PUPPY8PState();
}

class _PUPPY8PState extends State<PUPPY8P> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Drools Puppy Dog Food, 3kg with Free 1.2kg, Total 4.2 kg',
                style: TextStyle(
            ...
            Row(
              children: [
                Padding(
                  ...
                  child: Text('₹829', style: TextStyle(
                      color: Colors.black,
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text(
                '- Complete and balanced nutrition with Real Chicken, our Number 1 ingredient, helps in puppies’ growth and development', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- A great combination of ingredients with the goodness of Vitamins, Antioxidants and Minerals that maintain strong bones and a healthy digestive system', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text(
                '- DHA helps in Brain Development and Retinal function', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Specially designed kibbles help to control tartar build-up', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Highly Palatable and strengthen you pets Immune system', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Promotes optimum Growth, better Digestibility and health of your pet', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              ...
              child: Text('- Maintains healthy skin and coat', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              ...
              child: Text('- Ideal for all breeds of dogs', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
